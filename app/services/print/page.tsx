...
const items = [
  ...
  { num: '02', title: 'Packaging Design', desc: 'Boxes, bags, labels, and wrappers that make unboxing an experience. Designed to stand out on shelves and delight customers.' },
  { num: '03', title: 'Menus & Stationery', desc: 'Restaurant menus, letterheads, envelopes, and office stationery with the same precision and craft as your digital brand.' },
  { num: '04', title: 'Marketing Collateral', desc: 'Brochures, flyers, posters, and banners — all print-ready with correct bleeds, margins, and colour profiles for any printer.' },
  { num: '05', title: 'Signage & Display', desc: 'Exterior signage, window graphics, trade show displays, and environmental branding that makes your space an extension of your brand.' },
]

const deliverables = [
  'Print-ready files (CMYK, PDF)','Design for multiple print formats','Bleed & margin specifications',
  'Proof files for review','Source files (AI, PSD)','Printer-ready export package',
]
      ...
      <section className="relative overflow-hidden bg-white pt-48 pb-20">
        ...
        <div className="relative z-10 max-w-[1440px] mx-auto px-8 lg:px-16">
          ...
          <h1 className="text-[clamp(52px,6.5vw,92px)] font-black tracking-[-0.045em] leading-[0.93] text-dark-3 mb-6">
            Print &<br />
            <span className="font-display italic" style={{ background:'linear-gradient(125deg,#10B981,#8B5CF6,#F97316)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}>Packaging.</span>
          </h1>
          <p className="text-[17px] text-dark-3/45 max-w-[480px] leading-relaxed font-light">Physical brand touchpoints designed with the same precision as digital — because first impressions are tactile.</p>
        </div>
      </section>
          ...
          <div className="flex items-end justify-between mb-16">
            <div>
              ...
              <h2 className="text-[clamp(36px,4vw,56px)] font-black tracking-[-0.04em] text-dark-3 leading-none">
                Every physical<br />
                <span className="font-display italic" style={{ background:'linear-gradient(135deg,#10B981,#8B5CF6)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}>touchpoint.</span>
              </h2>
            </div>
          </div>
      ...
      <section className="relative overflow-hidden py-28" style={{ background:'#09091A' }}>
        ...
        <div className="relative z-10 max-w-[1440px] mx-auto px-8 lg:px-16 text-center">
          <h2 className="text-[clamp(36px,5vw,72px)] font-black tracking-[-0.04em] text-white leading-none mb-8">
            Make your brand<br />
            <span className="font-display italic" style={{ background:'linear-gradient(135deg,#34D399,#F97316)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}>tangible.</span>
          </h2>
